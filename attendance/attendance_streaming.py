...
global class_time ##값 받아오기 위해 전역으로 추가.
###############################
t = time.localtime()
...
def video_feed():
    global class_time
    return Response(stream_with_context(preprocess_video(mtcnn, model, clf, 0, absence_per, attend_per, class_time=class_time)),
